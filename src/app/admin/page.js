        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-4">
              ...
              <p className="text-gray-600 self-center">Всего картинок: {trips.length}</p>
            </div>
          </div>
      ...
      {showEditModal && editingTrip && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <h2 className="text-xl font-bold mb-4">Редактировать картинку</h2>
            
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Название картинки</label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Когда нарисована картинка</label>
              <input
                type="date"
            ...
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2">Описание картинки</label>
              <textarea
            ...
            {editingTrip.photos && editingTrip.photos.length > 0 && (
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2">Картинки</label>
